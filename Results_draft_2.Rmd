...
plot(results_lin$mwu$pval$nseqs, over_threshold2(results_lin$mwu$pval, 3:103, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the MWU customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin$classic$pval$Annotated, over_threshold(results_lin$classic$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the classic customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin$elim$pval$Annotated, over_threshold(results_lin$elim$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the Elim customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin$weight$pval$Annotated, over_threshold(results_lin$weight$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the weight customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")
...
par(mfrow=c(2,2))
# mwu
plot(results_lin$mwu$seq[,3],results_lin$mwu$seq_n[,3], ylim=c(0, 250), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (MWU FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin$mwu$seq[,i], results_lin$mwu$seq_n[,i], col="grey")
}
points(seq_info$FC.sep, seq_info$nmember_mwu, col="red")

# classic

plot(results_lin$classic$seq[keep,3], results_lin$classic$seq_n[,3], ylim=c(0, 250), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (Classic FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin$classic$seq[keep,i], results_lin$classic$seq_n[,i], col="grey")
}
points(seq_info$FC.sep, seq_info$nmember_classic_sig, col="red")

# elim

plot(results_lin$elim$seq[keep,3], results_lin$elim$seq_n[,3], ylim=c(0, 100), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (elim FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin$elim$seq[keep,i], results_lin$elim$seq_n[,i], col="grey")
}
points(seq_info$FC.sep, seq_info$nmember_elim_sig, col="red")

# weight

plot(results_lin$weight$seq[keep,3], results_lin$weight$seq_n[,3], ylim=c(0, 100), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (weight01 FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin$weight$seq[keep,i],results_lin$weight$seq_n[,i], col="grey")
}
points(seq_info$FC.sep, seq_info$nmember_weight_sig, col="red")
...
plot(mwu_lines$N, mwu_lines[,2], type="l", ylim=c(-1.6,2.4), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (MWU)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 2:101){
  lines(mwu_lines$N, mwu_lines[,i], col="grey")
}
lines(1:301, apply(mwu_lines[,c(2:101)],1, mean), col="red")
lines(orig_fc_N$N, orig_fc_N$median_mwu, col="black")


# classic

plot(classic_lines$N, classic_lines[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,120), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (Classic)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(classic_lines$N, classic_lines[,i], col="grey")
}
lines(1:301, apply(classic_lines[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
lines(orig_fc_N$N, orig_fc_N$median_classic, col="black")


# elim

plot(elim_lines$N, elim_lines[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,50), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (elim)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(elim_lines$N, elim_lines[,i], col="grey")
}
lines(1:301, apply(elim_lines[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
lines(orig_fc_N$N, orig_fc_N$median_elim, col="black")

# weight

plot(weight_lines$N, weight_lines[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,50), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (weight)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(weight_lines$N, weight_lines[,i], col="grey")
}
lines(1:301, apply(weight_lines[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
lines(orig_fc_N$N, orig_fc_N$median_weight01, col="black")
...
plot(results_lin_all$mwu$pval$nseqs, over_threshold(results_lin_all$mwu$pval, 3:103, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the MWU customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin_all$classic$pval$Annotated, over_threshold(results_lin_all$classic$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the classic customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin_all$elim$pval$Annotated, over_threshold(results_lin_all$elim$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the Elim customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin_all$weight$pval$Annotated, over_threshold2(results_lin_all$weight$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the weight customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")
...
par(mfrow=c(2,2))
# mwu
plot(results_lin_all$mwu$seq[,3],results_lin_all$mwu$seq_n[,3], ylim=c(0, 150), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (MWU FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_all$mwu$seq[,i], results_lin_all$mwu$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_mwu, col="red")

# classic

plot(results_lin_all$classic$seq[,3], results_lin_all$classic$seq_n[,3], ylim=c(0, 300), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (Classic FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_all$classic$seq[,i], results_lin_all$classic$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_classic_sig, col="red")

# elim

plot(results_lin_all$elim$seq[,3], results_lin_all$elim$seq_n[,3], ylim=c(0, 30), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (elim FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_all$elim$seq[,i], results_lin_all$elim$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_elim_sig, col="red")

# weight

plot(results_lin_all$weight$seq[,3], results_lin_all$weight$seq_n[,3], ylim=c(0, 30), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (weight01 FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_all$weight$seq[,i],results_lin_all$weight$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_weight_sig, col="red")
...
plot(mwu_lines_all$N, mwu_lines_all[,2], type="l", ylim=c(-1.6,2.4), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (MWU)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 2:101){
  lines(mwu_lines_all$N, mwu_lines_all[,i], col="grey")
}
lines(1:301, apply(mwu_lines_all[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_mwu, col="black")


# classic

plot(classic_lines_all$N, classic_lines_all[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,20), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (Classic)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(classic_lines_all$N, classic_lines_all[,i], col="grey")
}
lines(1:301, apply(classic_lines_all[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_classic, col="black")


# elim

plot(elim_lines_all$N, elim_lines_all[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,20), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (elim)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(elim_lines_all$N, elim_lines_all[,i], col="grey")
}
lines(1:301, apply(elim_lines_all[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_elim, col="black")

# weight

plot(weight_lines_all$N, weight_lines_all[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,20), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (weight)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(weight_lines_all$N, weight_lines_all[,i], col="grey")
}
lines(1:301, apply(weight_lines_all[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_weight01, col="black")
...
plot(results_lin_heat$mwu$pval$nseqs, over_threshold2(results_lin_heat$mwu$pval, 3:103, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the MWU customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin_heat$classic$pval$Annotated, over_threshold(results_lin_heat$classic$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the classic customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin_heat$elim$pval$Annotated, over_threshold(results_lin_heat$elim$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the Elim customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")

plot(results_lin_heat$weight$pval$Annotated, over_threshold2(results_lin_heat$weight$pval, 6:106, threshold)/100, main="Percentage of times a GO term was deemed significant
     at alpha=0.05 in the weight customsample (B=100)", ylab="Percentage of detected GO terms", xlab="Number of transcripts")
...
par(mfrow=c(2,2))
# mwu
plot(results_lin_heat$mwu$seq[,3],results_lin_heat$mwu$seq_n[,3], ylim=c(0, 50), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (MWU FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_heat$mwu$seq[,i], results_lin_heat$mwu$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_mwu, col="red")

# classic

plot(results_lin_heat$classic$seq[,3], results_lin_heat$classic$seq_n[,3], ylim=c(0, 50), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (Classic FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_heat$classic$seq[,i], results_lin_heat$classic$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_classic_sig, col="red")

# elim

plot(results_lin_heat$elim$seq[,3], results_lin_heat$elim$seq_n[,3], ylim=c(0, 50), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (elim FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_heat$elim$seq[,i], results_lin_heat$elim$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_elim_sig, col="red")

# weight

plot(results_lin_heat$weight$seq[,3], results_lin_heat$weight$seq_n[,3], ylim=c(0, 50), xlim=c(-6.5, 6), col="grey", ylab="Number of times Transcript was member \n of significant GO term",
     xlab="log2 Fold change", main="Fold change vs number of membership in significant GO terms (weight01 FC custom ) \n red = real data, grey = random resampling of FC")
for(i in 4:101){
  points(results_lin_heat$weight$seq[,i],results_lin_heat$weight$seq_n[,i], col="grey")
}
# points(seq_info$FC.sep, seq_info$nmember_weight_sig, col="red")
...
plot(mwu_lines_heat$N, mwu_lines_heat[,2], type="l", ylim=c(-1.6,2.4), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (MWU)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms", xlim=c(0,10))
for(i in 2:101){
  lines(mwu_lines_heat$N, mwu_lines_heat[,i], col="grey")
}
lines(1:301, apply(mwu_lines_heat[,c(2:101)],1 , function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_mwu, col="black")


# classic

plot(classic_lines_heat$N, classic_lines_heat[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,10), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (Classic)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(classic_lines_heat$N, classic_lines_heat[,i], col="grey")
}
lines(1:301, apply(classic_lines_heat[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_classic, col="black")


# elim

plot(elim_lines_heat$N, elim_lines_heat[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,10), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (elim)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(elim_lines_heat$N, elim_lines_heat[,i], col="grey")
}
lines(1:301, apply(elim_lines_heat[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_elim, col="black")

# weight

plot(weight_lines_heat$N, weight_lines_heat[,2], type="l", ylim=c(-2.7,3.4), xlim=c(0,10), col="grey", main="median log2FC of all transcripts with a certain number of significant GO terms (weight)
     grey=resampling(N=100), red=median, black=original", ylab="median log2FC", xlab="Number of GO terms")
for(i in 3:101){
  lines(weight_lines_heat$N, weight_lines_heat[,i], col="grey")
}
lines(1:301, apply(weight_lines_heat[,c(2:101)],1, function(x) mean(x, na.rm=T)), col="red")
# lines(orig_fc_N$N, orig_fc_N$median_weight01, col="black")
