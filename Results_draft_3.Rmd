...
```{r}
load("./data/20230725")
load("./data/results_final_KS.RData")
# load("./data/data_int_1.RData")
# load("./data/data_int_2.RData")
load("./data/results_final_mwu.RData")
...
par(mfrow=c(2,4))
for(j in 1:8){
plot(x=1:300, y=sapply(1:300, function(x) median(orig_mwu[[j]]$trans[,1][which(orig_mwu[[j]]$misc$trans$GO_N >= x)], na.rm=T)), type="l", ylim=c(-1, 1))
for(i in 2:100){
  lines(x=1:300, y=sapply(1:300, function(x) median(orig_mwu[[j]]$trans[,i][which(orig_mwu[[j]]$misc$trans$GO_N >= x)], na.rm=T)))
}
lines(x=1:300, sapply(1:300, function(x) median(unlist(orig_mwu[[j]]$trans[which(orig_mwu[[j]]$misc$trans$GO_N >= x),]), na.rm=T)), col="red")}
...
```{r}
ggplot(data=orig_GO_N[orig_GO_N$method!="lea",], mapping=aes(x=slope, y=N/100,col=fdr))+
  geom_boxplot()+
  facet_wrap(~method)+
...
```{r}
ggplot(data = orig_GO_N_o_t[orig_GO_N_o_t$method=="classic",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
...
```{r}
ggplot(data = orig_GO_N_o_t[orig_GO_N_o_t$method=="elim",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
   ggtitle("elim")+
  theme_minimal()
...
```{r}
ggplot(data = orig_GO_N_o_t[orig_GO_N_o_t$method=="weight",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
   ggtitle("weight")+
  theme_minimal()
...
```{r}
ggplot(data = orig_GO_N_o_t[orig_GO_N_o_t$method=="mwu",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("MWU")+
  theme_minimal()
...
```{r}
ggplot(data=orig_fc_o_trans[orig_fc_o_trans$method=="classic",], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("classic")+
  theme_minimal()
...
```{r}
ggplot(data=orig_fc_o_trans[orig_fc_o_trans$method=="elim",], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("elim")+
  theme_minimal()
...
```{r}
ggplot(data=orig_fc_o_trans[orig_fc_o_trans$method=="weight",], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("weight")+
  theme_minimal()
...
```{r}
ggplot(data=orig_fc_o_trans[orig_fc_o_trans$method=="mwu",], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("mwu")+
  theme_minimal()
...
ggplot(data=orig_lines[orig_lines$method=="classic",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  # geom_line(data=fin.data[fin.data$method=="classic",], mapping=aes(x=N, y=Median, group=slope), col="green")+
  facet_grid(fdr~slope)+
  ggtitle("classic")+
  theme_minimal()

ggplot(data=fin.data[fin.data$method=="elim",], mapping=aes(x=N, y=Median, group=slope))+
  geom_line()
```

```{r}
ggplot(data=orig_lines[orig_lines$method=="elim",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  facet_grid(fdr~slope)+
  ggtitle("elim")+
  theme_minimal()
...
```{r}
ggplot(data=orig_lines[orig_lines$method=="weight",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  facet_grid(fdr~slope)+
  ggtitle("weight")+
  theme_minimal()
...
```{r}
ggplot(data=orig_lines[orig_lines$method=="mwu",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  facet_grid(fdr~slope)+
  ggtitle("mwu")+
  theme_minimal()
...
```{r}
orig_median_line$Group <- rep(1:300, each=64)
ggplot(data=orig_median_line, mapping=aes(x=N, y=Median, col=slope, group=Group, line=slope))+
  geom_line()+
  facet_grid(fdr~method)+
  theme_minimal()
```
...
par(mfrow=c(2,4))
for(j in 1:8){
plot(x=1:300, y=sapply(1:300, function(x) median(rat_results[[j]]$classic$trans[,1][which(rat_results[[j]]$misc$trans$GO_N >= x)], na.rm=T)), type="l", ylim=c(-1, 1))
for(i in 2:100){
  lines(x=1:300, y=sapply(1:300, function(x) median(rat_results[[j]]$classic$trans[,i][which(rat_results[[j]]$misc$trans$GO_N >= x)], na.rm=T)))
}
lines(x=1:300, sapply(1:300, function(x) median(unlist(rat_results[[j]]$classic$trans[which(rat_results[[j]]$misc$trans$GO_N >= x),]), na.rm=T)), col="red")}
...
```{r}
ggplot(data=rat_GO_N[orig_GO_N$method!="lea",], mapping=aes(x=slope, y=N/100,col=fdr))+
  geom_boxplot()+
  facet_wrap(~method)+
  # geom_jitter(width=0.01)+
  theme_minimal()
...
ggplot(data = rat_GO_N_o_t[rat_GO_N_o_t$method=="classic",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("classic")+
  theme_minimal()
...
```{r}
ggplot(data = rat_GO_N_o_t[rat_GO_N_o_t$method=="elim",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
   ggtitle("elim")+
  theme_minimal()
...
```{r}
ggplot(data = rat_GO_N_o_t[rat_GO_N_o_t$method=="weight",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
   ggtitle("weight")+
  theme_minimal()
...
```{r}
ggplot(data = rat_GO_N_o_t[rat_GO_N_o_t$method=="mwu",], mapping=aes(x=log10(N_trans), y=N_sig/100, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("MWU")+
  theme_minimal()
...
```{r}
ggplot(data=rat_fc_o_trans[rat_fc_o_trans$method="classic"], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("classic")+
  theme_minimal()
...
```{r}
ggplot(data=rat_fc_o_trans[rat_fc_o_trans$method=="elim"], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("elim")+
  theme_minimal()
...
```{r}
ggplot(data=rat_fc_o_trans[rat_fc_o_trans$method=="weight"], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("weight")+
  theme_minimal()
...
```{r}
ggplot(data=rat_fc_o_trans[rat_fc_o_trans$method=="mwu"], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("mwu")+
  theme_minimal()
...
ggplot(data=rat_lines[rat_lines$method=="classic",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  # geom_line(data=rat_median_line[rat_median_line$method=="classic"], mapping=aes(x=N, y=Median), col="red")
  facet_grid(fdr~slope)+
  ggtitle("classic")+
  theme_minimal()
```
...
```{r}
ggplot(data=rat_lines[rat_lines$method=="elim",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  facet_grid(fdr~slope)+
  ggtitle("elim")+
  theme_minimal()
...
```{r}
ggplot(data=rat_lines[rat_lines$method=="weight",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  facet_grid(fdr~slope)+
  ggtitle("weight")+
  theme_minimal()
...
```{r}
ggplot(data=rat_lines[rat_lines$method=="mwu",], mapping=aes(x=N, y=Median, col=fdr, group=group))+
  geom_line()+
  facet_grid(fdr~slope)+
  ggtitle("mwu")+
  theme_minimal()
...
```{r}
ggplot(data=human_GO_N[orig_GO_N$method!="lea",], mapping=aes(x=slope, y=N/100,col=fdr))+
  geom_boxplot()+
  facet_wrap(~method)+
  # geom_jitter(width=0.01)+
  theme_minimal()
...
```{r}
ggplot(data=human_fc_o_trans[human_fc_o_trans$method=="weight"], mapping=aes(x=log2FC, y=N, col=fdr))+
  geom_point()+
  facet_grid(fdr~slope)+
  ggtitle("weight")+
  theme_minimal()
